...
from config import alpha, beta, power, GLOBAL_SIZE_TH, base_ctr, \
                   ...
                   alpha_prior, beta_prior, resolution, toc, iterations, prob_th, ab_type
...
if __name__=='__main__':
    ...
    total_stats_df[['mde',
                    ...
                    'sample_size_total',
                    'sample_size_avg',
                    'sample_size_std']].round(4).to_csv("reports/I_TYPE_ERROR_{ab_type}_{params}.csv".format(ab_type=ab_type,
                                                                                            params=params),
                                               index=None)
